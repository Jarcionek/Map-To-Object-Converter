 ...
 * </ul>
 * Also, in key case insensitive mode, when:
 * <ul>
 *     <li>target class to convert map to contains fields which are equal ignoring case</li>
 *     <li>map to convert contains keys which are equal ignoring case</li>
 * </ul>
 */
